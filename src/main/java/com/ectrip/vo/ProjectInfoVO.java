...
public class ProjectInfoVO {
    ...
    public ProjectInfoVO(Integer id, Integer projectId, String serverIp, String dbServerIp, String dbUser, String dbPwd, Integer dbPort, String hostName, String ssh) {
        this.id = id;
        this.projectId = projectId;
        this.serverIp = serverIp;
        this.dbServerIp = dbServerIp;
